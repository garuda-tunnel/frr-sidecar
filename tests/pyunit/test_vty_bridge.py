"""Behavioral tests for the vty_bridge Flask app."""
...
def test_vtysh_happy_path(client, monkeypatch):
    ...
    monkeypatch.setattr(vty_bridge.subprocess, "run", lambda *a, **k: fake)
...
def test_vtysh_timeout_returns_504(client, monkeypatch):
    ...
    monkeypatch.setattr(vty_bridge.subprocess, "run", raise_timeout)
...
def test_vtysh_oserror_returns_500(client, monkeypatch):
    ...
    monkeypatch.setattr(vty_bridge.subprocess, "run", raise_oserror)
